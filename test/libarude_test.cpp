...
#define BOOST_TEST_MODULE libarude_test

#include "libarude_test.hpp"

//---------------------------------------------------------------------------
BOOST_AUTO_TEST_CASE(libarude_initial_test)
{
  BOOST_CHECK_EQUAL(true, true); // Dummy test to eliminate warning
}